...
class UpdateGameStateTest extends UnitSpec {
  ...
  it should "populate the target after a double pawn push" in {
    ...
    val updatedGameState1 =
      updateGameState(gameState, Move(whitePawnPos, whitePawnPos + Position(-2, 0)))
    val updatedGameState2 =
      updateGameState(updatedGameState1, Move(blackPawnPos, blackPawnPos + Position(2, 0)))
  ...
  it should "remove the previous double-pushed pawn" in {
    ...
    val updatedGameState1 = updateGameState(gameState, Move(Position(1, 3), Position(3, 3)))
    val updatedGameState2 = updateGameState(updatedGameState1, Move(Position(3, 2), Position(2, 3)))
  ...
  it should "be disabled after a king move" in {
    ...
    val updatedGameState1 = updateGameState(gameState, Move(Position(0, 4), Position(1, 4)))
    val updatedGameState2 = updateGameState(updatedGameState1, Move(Position(7, 4), Position(7, 5)))
  ...
  it should "be disabled even if king moves back to original position" in {
    ...
    val updatedGameState1 = updateGameState(gameState, Move(Position(0, 4), Position(1, 4)))
    val updatedGameState2 = updateGameState(updatedGameState1, Move(Position(6, 2), Position(5, 2)))
    val updatedGameState3 = updateGameState(updatedGameState2, Move(Position(1, 4), Position(0, 4)))
  ...
  it should "be disabled for rook after rook moves" in {
    ...
    val updatedGameState1 = updateGameState(gameState, Move(Position(7, 7), Position(6, 7)))
  ...
  it should "be disabled for rook even if rook moves back to original position" in {
    ...
    val updatedGameState1 = updateGameState(gameState, Move(Position(7, 7), Position(6, 7)))
    val updatedGameState2 = updateGameState(updatedGameState1, Move(Position(1, 0), Position(2, 0)))
    val updatedGameState3 = updateGameState(updatedGameState2, Move(Position(6, 7), Position(7, 7)))
